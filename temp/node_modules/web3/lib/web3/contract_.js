 ...
 */
ContractFactory.prototype.at = Contract.bind(null, 'test');//function (address, callback) {
...
eventemitter = web3.eth.contract.deploy(param1, {data: '0x23456'});
...
 });
web3.eth.contract.getData(abi, param1, {data: '0x23456'})
> 0x23456780000005345345
myContrac.myMethod(param1)
myContrac.myMethod.getData(param1)
